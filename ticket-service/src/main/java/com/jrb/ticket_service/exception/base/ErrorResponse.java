 ...
 * to clients.
 * 
 * @param errorCode error code enum identifying the type of error
...
public record ErrorResponse(
                @Schema(description = "Error code identifying the type of error. All possible values are defined in the ErrorCode enum.", implementation = ErrorCode.class) ErrorCode code,
